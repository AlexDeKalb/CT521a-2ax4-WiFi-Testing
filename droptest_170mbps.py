...
cx_bandwidth = [20, 20, 10, 10, 10, 30, 10, 50, 5, 5]
...
for cxs in cx:
    ...
    print("30 second sleep to allow CXs to come up")   
...
# plt.bar(X, Y, color='g', width = 3)
# plt.title("Drop Percentage as Bandwidth increases")
# plt.xlabel("Drop %")
