...
os.system("./create_station.py --radio wiphy0 --ssid SpectrumSetup-35 --passwd cleancrown810 --security wpa2 --num_stations 7")
os.system("./create_station.py --radio wiphy1 --ssid SpectrumSetup-35 --passwd cleancrown810 --security wpa2 --num_stations 7 --start_id 0007")
